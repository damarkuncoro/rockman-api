// rockman-app/src/test/services/users/integration/users.service.post.integration.test.ts
/**
 * Integration Tests untuk Users Service POST Operations dengan Real Repository
 * Fokus pada testing operasi POST (INSERT) dengan database real
...
/**
 * Integration Tests untuk Users Service POST Operations
 * Testing operasi INSERT dengan database sesungguhnya
 */
describe('Users Service - POST Operations Integration Tests', () => {
  ...
  describe('POST Operations - Integration', () => {
    it('harus dapat membuat user baru di database', async () => {
      // Arrange
      ...
      console.log('Integration test - POST Create result:', result)
      ...
      expect(result.department).toBe(newUserData.department)
      expect(result.createdAt).toBeDefined()
      expect(result.updatedAt).toBeDefined()

      // Track for cleanup
      testHelper.trackUserId(result.id)
    })
  })
})